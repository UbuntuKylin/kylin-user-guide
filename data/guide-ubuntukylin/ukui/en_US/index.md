...
## Overview
Desktop Environment is the basis for the user's operation on the graphical interface, and provides multiple functions including taskbar, start menu, etc. The main interface is shown in Figure 1.
...
### Right-click Menu
Right-click on the desktop blank and a menu appears as shown in Figure 3, providing the users with some shortcut features.
...
## Taskbar
### Basic Function
Taskbar is located at the bottom and includes the Start Menu, Multi View Switch, File Browser, Firefox Web Browser, WPS, and Tray Menu, as shown in Figure 4.
...
#### Preview Window
Users move the mouse over the app icon in the taskbar, and then a small preview window will be shown if this app has already been opened. The hover state is shown in Figure 6. This window renders a hairy glass effect and the rest of the windows remain the default state.

![Fig 6 Taskbar - Preview Window](image/6.png)

Users can preview the currently opened windows of that application in the form of a list by right-clicking on the app icon in the taskbar, as shown in Figure 7.

![Fig 7 Taskbar - Right-click Preview](image/7.png)

#### Sidebar
The sidebar is located at the right of the entire desktop. Click the icon “![](image/icon11-o.png)” in the taskbar tray menu to open the storage menu, and click the icon “![](image/icon12-o.png)” in Kylin Toolbox to pop up the sidebar as shown in Figure 8. The sidebar consists of two parts: Notification Center and Clipboard.

![Fig 8 Sidebar without message status-big](image/8.png)

##### Notification Center
Notification center will display a list of recent important and newest informations, as shown in Figure 9. Select "Clear" in the upper right corner to clear the list of informations; Select "Setting" in the upper right corner to go to the notification settings in the control center, and users can set which applications can show informations and the quantity of informations.

![Fig 9 Notification Center-big](image/9.png)

Workspace at right side can be set to fold by applications, as shown in Figure 10.

![Fig 10 Fold messages by applications-big](image/10.png)

Icon “![](image/icon13-o.png)” at the top right corner of the sidebar can store unimportant informations, as shown in Figure 11. When the messages are more than 999+, it will be shown as the form of ![](image/icon14-o.png) which means limitless.

![Fig 11 Message Organizer](image/11.png)

##### Clipboard
As Figure 12, clipboard can save the contents those were recently selected to copy or cut, and  users can operate them by using the icons in Table 4.

![Fig 12 Clipboard](image/12.png)

Clicking “![](image/icon15-o.png)”, you can edit the the contents of the clipboard, as shown in Figure 13.
...
When no power supply is detected, power manager is shown like Figure 17.

![Fig 17 No Power Supply](image/17.png)

When power supply is detected, power manager is shown like Figure 18.

![Fig 18 Have Power Supply](image/18.png)

Users right-click the icon “![](image/icon30-o.png)” of power manager to open the power setting menu as shown in Figure 19. It provides three setting options: show the power percentage of the power device, adjust screen brightness, and set power and sleep.

![Fig 19 Power Manager](image/19.png)

If the power manager pops up a“low battery” window as shown in Figure 20, users can click to turn on the power save mode, and the power manager will set the machine to run in this mode immediately.

![Fig 20 Power Saving Mode](image/20.png)

##### Network
Users can choose wired or wireless network connections by clicking the icon “![](image/icon31-o.png)” of network manager. As shown in Figure 21.
...
###### 1) Wired Network
In the wired network connection interface, click on the wired network plan to expand. Details of the network as shown in Figure 22.
...
###### 3) Network Setting
Right-click the icon “![](image/icon42-o.png)” of network mnager to pop up the setting menu, as shown in Figure 24.

![Fig 24 Wired Network Setting](image/24.png)

Click network setting to go to the setting window immediately, as shown in Figure 25.
...
It contains input equipments and output equipments, as shown in Figure 27.

![Fig 27 According to Equipment List](image/27.png)

###### 3) According to Application
It contains system volume and other applications’ volume, as shown in Figure 28.

![Fig 28 According to Application List](image/28.png)

##### Calendar
Click the date&time on the taskbar to open the calendar window, as shown in Figure 29. 
...
#### Advanced Setting
Right-click the Taskbar to open the menu as shown in Figure 31.
...
## Start Menu
### Basic Function
Click the button to open the “Start Menu”, as shown in Figure 32. It provides sliding bar.

![FIg 32 Start Menu](image/32.png)

#### Category Menu at right side
When the mouse is over the right side of the start menu, it will appear a pre-expanded cue bar. Clicking to expand, and then three categories are showing at the right side by default: “Common Software”, “Alphabetical Category”, and "Functional category". As shown in Figure 33.
...
Users can click the button at top right corner to view fullscreen menu mode, as shown in Figure 34.
...
It will pop up a dialog box as shown in Figure 36, and users can choose shutdown or reboot as needed.
...
### Applications
Users can search apps in the search box by key words. As shown in Figure 37, the result will show up automatically with the input.

![Fig 37 Search Apps](image/37.png)

Right-clicking one app in the Start Menu, the right-click menu poping up is like Figure 38.
