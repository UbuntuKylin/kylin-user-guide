...
![图 9 鼠标设备](image/9.png)

### 键盘
通过控制面板设备中键盘模块，可对键盘进行常规通用设置，并能够根据键盘语言调整键盘布局。

![图 10 键盘设备](image/10.png)
...
![图 27 纯色背景设置](image/27.png)

#### 图片
在选择桌面背景>选择背景形式下选择：图片。

![图 28 图片背景设置](image/28.png)
...
![图 32 字体设置](image/32.png)

## 网络
网络代理主要是配置网络代理相关设置，分网络连接、VPN、代理三个模块，如图 33所示。

![图 33 网络设置](image/33.png)
