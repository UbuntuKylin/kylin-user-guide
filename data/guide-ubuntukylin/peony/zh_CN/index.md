...
### 高级搜索功能
文件浏览器为用户提供高级搜索功能，简单的搜索即：在搜索框中输入搜索内容后，点击“![](image/icon18-o.png)”图标在当前路径下对该文件进行搜索，如图 13所示。

![图 13 高级搜索功能](image/13.png)
...
![图 19 连接提示](image/19.png)

（3）连接后，可看到共享文件内的内容，在侧边栏也会显示接入的主机，如图 20所示。

![图 20 共享文件夹内容](image/20.png)
