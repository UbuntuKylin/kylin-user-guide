...
## 任务栏
任务栏位于底部，包括开始菜单、文件管理器、Firefox网络浏览器、WPS、托盘菜单等，如图4所示。
...
![图 6 预览窗口-big](image/6.png)

鼠标右键点击任务栏的应用图标，可关闭该应用当前打开的所有窗口，如图7所示。
...
![图 8 日历查看-big](image/8.png)

### 设置任务栏
右键单击任务栏，用户可对任务栏的布局进行设定。

![图 9 任务栏右键菜单](image/9.png)
<br>

## 侧边栏
侧边栏是桌面环境软件之一，可收纳用户尚未查看的消息通知，保存用户日常操作的剪贴字段，并提供了一些小插件。

点击任务栏右侧托盘菜单中的侧边栏图标![](image/icon10.png)，弹出界面如图10所示。

![图 10 侧边栏-big](image/10.png)

### 通知中心
通知中心将会显示最新的信息列表。默认状态下，提示“没有消息通知”；有通知时，如图11所示。

![图 11 通知中心](image/11.png)

其中，点击![](image/icon11.png)可以把该条消息设为不重要的信息，并收纳起来。
...
| 图标 | 说明 | 图标 | 说明 |
| :------------ | :------------ | :------------ | :------------ |
|![](image/icon12.png)|	固定剪切板上的该内容 |![](image/icon14.png)| 编辑剪切板上的该内容（仅限文字内容） |
|![](image/icon13.png)|	删除剪切板上的该内容 |||	
...
![图 13 小插件](image/13.png)

#### 闹 钟
闹钟提供了倒计时，闹钟，秒表的功能，可通过顶部三个图标切换。

![图 14 添加闹钟](image/14.png)
...
![图 18 网络设置](image/18.png)

![图 19 编辑界面](image/19.png)
...
单击“开始菜单”按钮，如图22所示，为按字母排序显示系统应用。

![图 22 开始菜单](image/22.png)

### 分类菜单
右侧边提供三种分类方式：“所有软件”、“字母排序”、“功能分类”，其中：

* 所有软件：按照使用频率列出系统中所有软件，并支持将软件固定至前端，不受使用频率影响

* 字母排序：根据中文首字母分类显示系统所有软件，并支持字母导航

* 功能分类：根据功能分类显示系统所有软件；分类包括移动软件，网络，社交，影音，开发，图像，游戏，办公，教育，系统和其它。

点击右上角的全屏图标![](image/icon15.png)，进入全屏菜单。

![图 23 全屏开始菜单-big](image/23.png)

### 应 用
用户可以在搜索框中，通过关键字搜索应用。搜索界面支持中英文与首字母实时搜索，查询结果会随着输入自动显示出来。

![图 24 搜索应用](image/24.png)

右键点击开始菜单中的某个应用，可将选中应用固定到“所有软件”/任务栏，添加到桌面快捷方式，或是卸载该应用。

![图 25 应用的右键菜单](image/25.png)

### 快捷功能键
* 点击“![](image/icon16.png)”，查看用户信息。

* 点击“![](image/icon17.png)”，进入计算机目录。

* 点击“![](image/icon18.png)”，进入控制面板。
