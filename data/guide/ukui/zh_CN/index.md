...
## 桌面
### 桌面图标
系统默认放置了“我的电脑”、“回收站”、“个人”三个图标，鼠标左键双击即可打开页面。功能如下。
...
### 任务栏
#### 基本功能
任务栏位于底部，包括开始菜单、Firefox网络浏览器、文件浏览器和状态菜单，如图 4所示。
...
在“任务栏设置”中，可进行相关设置，包括任务栏透明度、位置、高度、是否锁定任务栏等，如图 6所示。若想要直接恢复默认设置，可选择右键菜单中的“重置该面板”。
...
工作区默认为2行2列，左键单击不同的区块，可以直接切换工作区；右键单击工作区，可进行设置，如图 7所示。
   
![图 7 工作区右键菜单和设置](image/7.png)
<br>
...
用户还可以在搜索框中，通过关键字搜索应用。如图 9所示，可输入中文，也可以输入软件包名，查询结果会随着输入自动显示出来。

![图 9 搜索应用](image/9.png)

### 高级功能
右键单击开始菜单图标，会出现如图 10所示的选项。
 
![图 10 开始菜单右键选项](image/10.png)

通过“属性”，可以对开始菜单的类型、历史打开文件/应用的显示、透明度进行设置，如图 11。
...
* 分类菜单：在“所有程序”中，对应用进行分类显示，如图 12。
 
![图 12 分类菜单显示](image/12.png)

### 应用
对开始菜单中的某个应用右键单击，会出现如图 13所示的菜单。
...
## 关机菜单
关机菜单位于“开始菜单”左下角的“关闭”按钮处，如图 14所示。
...
系统还提供了定时关机的功能，用户可根据需要设置关机时间和关机频率。
