...
### 操作日志
记录了在备份还原工具上的所有操作，主界面如图 11所示。可通过“上一页” 、“下一页”按钮进行翻页查看。
...
#### 创建Ghost镜像
选择菜单“Ghost镜像”，主界面如图 12所示，包含了几点提示。
...
4）双击安装图标，开始安装引导。在“安装方式”中选择“从Ghost镜像安装”，并找到移动设备中的Ghost镜像文件。后续安装步骤可参考安装手册。
...
## LiveCD还原
通过系统启动盘进入操作系统后，点击“开始菜单” > “所有软件” > “麒麟备份还原工具”打开软件，主界面如图 17所示。
