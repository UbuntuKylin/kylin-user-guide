...
用户可以通过点击：开始菜单 > 控制面板 > 硬件配置 > 打印机，进入打印机配置界面，添加、管理打印机设备，主界面如图1所示。
