...
![图 7 默认应用-big](image/7.png)

### 时间和日期
配置时间、日期、时区等相关设置。
 
![图 8 时间和日期-big](image/8.png)
...
![图 26 存在应用程序输出音频-big](image/26.png)
...
![图 32 网络代理详情](image/32.png)

勾选“用户认证”选项后才可以填写“用户名”、“密码”，如图38所示
 
![图 33 勾选用户认证](image/33.png)
