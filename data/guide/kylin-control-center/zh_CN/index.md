...
![图3主题-big](image/3.png)

- **字体** 

提供系统字体及字体大小的配置项，主界面如图所示
 
![图4字体-big](image/4.png)
...
![图7默认应用-big](image/7.png)

### 2.4 时间和日期

配置时间、日期、时区等相关设置。
 
![图8时间和日期-big](image/8.png)
...
硬件配置包括 **键盘** 、 **鼠标** 、 **声音** 、 **网络代理** 、 **显示器** 、 **电源管理** 六个功能。
...
![图26存在应用程序输出音频-big](image/26.png)
