...
延时设置只针对于“抓取整个桌面”和“抓取当前窗口”有效，延时时长设置如图 79所示。
...
包含庄口边框特效只针对于“抓取当前窗口”有效，其应用特效有：无、阴影、边框，如图 80所示。

![图 80 窗口边框应用特效](image/80.png)
...
#### 大写开启与关闭
用户通过点击“![](image/icon43.png)”图标，可以对键盘的大小写进行设定，如图 85所示。

![图 85 大写开启与关闭](image/85.png)

#### 切换单击帮助程序
用户通过点击“![](image/icon47.png)”图标，切换单击帮助程序，如图 86所示。
