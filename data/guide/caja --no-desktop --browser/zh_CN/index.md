...
| 图标  | 说明  |
| :------------ | :------------ |
| ![](a.png)  | ① 转到上一个访问过的位置；② 查看后退历史  |
| ![](b.png)  | ① 转到下一个访问过的位置；② 查看前进历史  |
| ![](c.png)  | 回到上一级目录  |
| ![](d.png)  | 文本框式地址栏，不仅可以输入本机的文件或目录路径，还可以输入一个局域网中共享的文件路径，或是一个ftp地址  |
| ![](e.png)  | 搜索栏，搜索用户所需要的文件  |
| ![](f.png)  | 设置文件查看方式为 “图标视图” / “列表视图”  |
